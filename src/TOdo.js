                    ...
                    <ul className='list-group'>
                        {
                            todos.map((item) => <li className='list-group-item bg-info d-flex justify-content-between align-items-center my-2'>
                                ...
                                <div className='d-flex gap-2'>
                                    ...
                                    {editId == -1 || editId !== item._id ? <button className='btn btn-danger' onClick={() => { handeDelete(item._id) }}> Delete</button> : <button className='btn btn-danger' onClick={handleEditCancel}> Cancel</button>}
                                </div>
                            </li>)
                        }
